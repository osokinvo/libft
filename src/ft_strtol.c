...
/*   Updated: 2020/02/15 15:08:56 by ghusk            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static long	ft_strtolneg(const char *nptr, char **end,
unsigned int base)
{
	g_str++;
	g_cutoff = -(unsigned long)LONG_MIN;
...
long int	ft_strtol(const char *nptr, char **end, unsigned int base)
{
	g_str = nptr;
	g_any = -1;
	g_result = 0;
